...
// and answers as specified in the questions class
  ...
  List<Question> _questionList = [
    ...
    Question(question: 'How often do you remember waking up during last night?', status: false, type: 'slider', low: '', high: '', data: null),
    ...
    Question(question: 'On the scale of 0-10, how would you rate the quality of your sleep last night?', status: false, type: 'slider', low: 'Very poor', high: 'Very goof', data: null),
    Question(question: 'How would you rate your low back pain on average during last night?', status: false, type: 'slider', low: 'No pain', high: 'Worst imaginable pain', data: null),
